			...
			<main className="mx-auto max-w-6xl px-6 py-10">
				<section className="mb-10 max-w-2xl">
					...
					<p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
						...
						Hintergrund und Typografie abgeleitet und als geschichtete
						Vektor-SVGs im Signature-Flat-Look zusammengesetzt. Gleicher Text
						erzeugt immer exakt dasselbe Cover.
					</p>
				</section>
